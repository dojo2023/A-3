...
<!--  <h3>今週のトレンド</h3>  -->
 ...
 <div class="box29">
  ...
  <div class="wrap slider" ontouchstart="">
        <div class="slide">
        <img class="item1 item" src="./img/メンズ春1.jpg" alt="">
        <img class="item2 item" src="./img/ウィメンズ春1.jpg" alt="">
        <img class="item3 item" src="./img/メンズ春2.jpg" alt="">
        <img class="item4 item" src="./img/メンズ夏1.jpg" alt="">
         <img class="item4 item" src="./img/ウィメンズ夏1.jpg" alt="">
        <img class="item1 item" src="./img/ウィメンズ春2.jpg" alt="">
        <img class="item2 item" src="./img/メンズ夏2.jpg" alt="">
        <img class="item3 item" src="./img/ウィメンズ夏2.jpg" alt="">
        <img class="item4 item" src="./img/メンズ夏3.jpg" alt="">
    </div>
    </div>
    </div>
...
<ul class="slideshow" id="images">
    ...
    <li class="content content-hover"><img src="./img/ウィメンズ春1.jpg"></li>
    <li class="content content-hover"><img src="./img/メンズ冬1.jpg"></li>
</ul>
</div>
</div>--%>
<div style="display: flex; justify-content: center;">
<input type="button" class="button-036" value="みんなのコーデ一覧はこちら" onclick="location.href='/TRex/ListServlet'">
</div>
